 ...
 * @version $Id$
 */ 
class ilXapiCmi5LrsTypesTableGUI extends ilTable2GUI {
    ...
    {
        global $ilCtrl, $lng;
        $this->addColumn($this->plugin_object->txt('conf_title'), 'title', '50%');
    ...
    function getMyDataFromDb() 
    {
        ...
        $data = ilXapiCmi5LrsType::_getTypesData(true);
