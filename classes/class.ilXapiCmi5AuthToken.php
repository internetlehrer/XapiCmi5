...
class ilXapiCmi5AuthToken
{
    ...
    const DB_TABLE_NAME = 'xxcf_token';
    ...
    /**
     * @param $token
     * @return ilXapiCmi5AuthToken
     * @throws ilXapiCmi5Exception
     */
    public static function getInstanceByToken($token)
    {
        ...
        throw new ilXapiCmi5Exception('no valid token found for: ' . $token);
    }
    ...
    public static function getInstanceByObjIdAndUsrId($objId, $usrId, $checkValid = true)
    {
        ...
        throw new ilXapiCmi5Exception('no valid token found for: ' . $objId . '/' . $usrId);
    }
    ...
    */
    ...
    public static function getCmi5SessionByUsrIdAndObjIdAndRefId(int $usrId, int $objId, $refId = null)
    {
        ...
        throw new ilXapiCmi5Exception('no valid cmi5_session found for: ' . $objId . '/' . $usrId);
    }
    ...
    public static function getWacSalt()
    {
        ...
        throw new ilXapiCmi5Exception('no salt for encryption provided');
    }
