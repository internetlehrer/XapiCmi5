...
class ilXapiCmi5Result
{
    const DB_TABLE_NAME = 'xxcf_results';
    ...
    protected function update()
    {
        ...
        $DIC->database()->update(self::DB_TABLE_NAME, array(
                ...
                'last_update' => array('timestamp', ilXapiCmi5AuthToken::selectCurrentTimestamp())
            ), array(
    ...
    protected function insert()
    {
        ...
        $this->setId($DIC->database()->nextId(self::DB_TABLE_NAME));
        
        $DIC->database()->insert(self::DB_TABLE_NAME, array(
