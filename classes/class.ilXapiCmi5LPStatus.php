...
/**
 * Class ilXapiCmi5LPStatus
 *
 * This class is an adapter to access protected methods of ilLPStatusPlugin
 * It is used by the ilLPStatusPluginInterface methods of ilObjXapiCmi5
 *
 ...
 * It must, however, be deliverd by methods of ilObjXapiCmi5
 *
 * Example:
 ...
 */
class ilXapiCmi5LPStatus extends ilLPStatusPlugin
{
    /**
     * Get the LP status data directly from the database table
     * This can be called from ilObjXapiCmi5::getLP* methods avoiding loops
     *
     * @param $a_obj_id
     * @param $a_status
     * @return mixed
